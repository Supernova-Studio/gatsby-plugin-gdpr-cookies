...
exports.initializeFacebookPixel = function (options) {
  if (!window.gatsbyPluginGDPRCookiesFacebookPixelInitialized && isEnabled(options) && validFbPixelId(options)) {
...
exports.trackFacebookPixel = function (options) {
  if (isEnabled(options) && validFbPixelId(options) && typeof window.fbq === "function") {
