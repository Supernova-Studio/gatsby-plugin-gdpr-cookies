...
exports.initializeTikTokPixel = function (options) {
  if (!window.gatsbyPluginGDPRCookiesTikTokPixelInitialized && isEnabled(options) && validTikTokPixelId(options)) {
...
exports.trackTikTokPixel = function (options) {
  if (isEnabled(options) && validTikTokPixelId(options) && typeof window.fbq === "function") {
