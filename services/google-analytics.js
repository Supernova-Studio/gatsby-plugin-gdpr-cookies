...
exports.initializeGoogleAnalytics = function (options) {
  if (!window.gatsbyPluginGDPRCookiesGoogleAnalyticsInitialized && isEnabled(options) && validGATrackingId(options)) {
...
exports.trackGoogleAnalytics = function (options, location) {
  if (isEnabled(options) && validGATrackingId(options) && typeof window.gtag === "function") {
